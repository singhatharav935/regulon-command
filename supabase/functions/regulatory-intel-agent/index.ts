...
const USER_AGENTS = [
  "REGULON-Compliance-Agent/2026 (+https://regulon.in/security; contact=ops@regulon.in)",
  "REGULON-Compliance-Agent/2026 sovereign-monitor",
  "REGULON-Compliance-Agent/2026 compliance-radar",
];
...
serve(async (req) => {
  ...
  try {
    ...
    if (req.method === "GET" && path.endsWith("health")) {
      return json(200, { ok: true, agent: "regulon-agent", time: new Date().toISOString() });
    }
