          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                SANNIDH is committed to customer satisfaction. This Refund & Cancellation Policy outlines the terms under which customers may request refunds or cancel their subscriptions to our compliance automation platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">
                SANNIDH offers the following subscription types:
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>Email support@sannidh.ai with "Cancellation Request" in subject</li>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside text-muted-foreground space-y-2">
                <li>Email refunds@sannidh.ai with:
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                If SANNIDH experiences more than <strong>4 hours</strong> of unplanned downtime in a billing cycle:
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>Contact our support team at billing@sannidh.ai</li>
            ...
            <section>
              ...
              <div className="bg-muted/30 rounded-lg p-4">
                ...
                <ul className="list-none text-muted-foreground space-y-1">
                  <li>📧 Email: refunds@sannidh.ai</li>
