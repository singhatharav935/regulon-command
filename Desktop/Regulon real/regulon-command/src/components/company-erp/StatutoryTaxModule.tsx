        ...
        <div className="rounded-2xl border border-white/8 bg-card/40 overflow-hidden">
          <div className="px-4 py-3 border-b border-white/8 flex items-center justify-between bg-white/2">
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">AY 2026-27 · Total TDS Credit: {fmt(form138.total_tds_credit)}</p>
            </div>
          ...
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-white/3">
              {form138.entries.map((e: any, i: number) => (
        ...
        <div className="rounded-2xl border border-white/8 bg-card/40 overflow-hidden">
          <div className="px-4 py-3 border-b border-white/8 flex items-center justify-between bg-white/2">
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">{form140.quarter} · Total TDS Deposited: {fmt(form140.total_tds_deducted)}</p>
            </div>
          ...
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-white/3">
              {form140.entries.map((e: any, i: number) => (
                <tr key={i} className="hover:bg-white/3">
        ...
        <div className="rounded-2xl border border-white/8 bg-card/40 overflow-hidden space-y-4 p-4">
          <div className="flex items-center justify-between border-b border-white/8 pb-3">
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">Certified by {form143.auditor_name} ({form143.firm_name})</p>
            </div>
            <div className="text-right">
              <span className="text-[10px] font-mono text-cyan-400">UDIN: {form143.udin}</span>
              <p className="text-[10px] text-green-400 font-semibold mt-0.5">✓ {form143.opinion_type}</p>
            </div>
          </div>
          <div className="space-y-2">
            {form143.clauses.map((c: any) => (
        ...
        <div className="rounded-2xl border border-white/8 bg-card/40 p-4 space-y-3">
          <div className="flex items-center justify-between border-b border-white/8 pb-3">
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">Associated Enterprise: {form144.associated_enterprise_name}</p>
            </div>
            <span className="text-[10px] font-mono text-cyan-400">UDIN: {form144.udin}</span>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
            <div className="p-3 rounded-xl bg-white/3 border border-white/5">
              <p className="text-[10px] text-muted-foreground">Transactions Count</p>
              <p className="text-base font-bold mt-1">{form144.international_transactions_count}</p>
            </div>
            <div className="p-3 rounded-xl bg-white/3 border border-white/5">
              <p className="text-[10px] text-muted-foreground">Total Value</p>
              <p className="text-base font-bold font-mono text-cyan-300 mt-1">{fmtL(form144.total_transaction_value)}</p>
            </div>
            <div className="p-3 rounded-xl bg-white/3 border border-white/5">
              <p className="text-[10px] text-muted-foreground">Method Used</p>
              <p className="text-xs font-bold text-purple-300 mt-1">{form144.arm_length_method_used}</p>
            </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="p-3 rounded-xl border border-cyan-500/20 bg-cyan-500/5">
          ...
          <p className="text-lg font-bold font-mono text-foreground mt-1">{fmtL(at.estimated_taxable_income)}</p>
          <p className="text-[10px] text-muted-foreground mt-0.5">Rate: {at.effective_tax_rate}% u/s 115BAA</p>
        </div>
        <div className="p-3 rounded-xl border border-amber-500/20 bg-amber-500/5">
          <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Gross Corporate Tax</p>
          <p className="text-lg font-bold font-mono text-amber-300 mt-1">{fmtL(at.gross_tax_liability)}</p>
          <p className="text-[10px] text-muted-foreground mt-0.5">Less TDS: {fmt(at.less_tds_tcs_credit)}</p>
        </div>
        <div className="p-3 rounded-xl border border-green-500/20 bg-green-500/5">
          ...
          <p className="text-lg font-bold font-mono text-green-300 mt-1">{fmtL(at.net_advance_tax_payable)}</p>
        ...
        <div className="p-3 rounded-xl border border-purple-500/20 bg-purple-500/5">
          ...
          <p className="text-lg font-bold font-mono text-purple-300 mt-1">{fmt(at.total_interest_234C + at.interest_234B)}</p>
          <p className="text-[10px] text-muted-foreground mt-0.5">234C: {fmt(at.total_interest_234C)} · 234B: {fmt(at.interest_234B)}</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-white/8 bg-card/40 p-4 space-y-3">
        ...
        <div className="grid md:grid-cols-3 gap-3 text-xs">
          <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20 space-y-2">
            ...
            <div className="flex justify-between"><span>IGST:</span><span className="font-mono">{fmt(setOff.output_liability.igst)}</span></div>
            <div className="flex justify-between"><span>CGST:</span><span className="font-mono">{fmt(setOff.output_liability.cgst)}</span></div>
            <div className="flex justify-between"><span>SGST:</span><span className="font-mono">{fmt(setOff.output_liability.sgst)}</span></div>
          </div>
          <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20 space-y-2">
            ...
            <div className="flex justify-between"><span>IGST ITC:</span><span className="font-mono">{fmt(setOff.itc_opening.igst)}</span></div>
            <div className="flex justify-between"><span>CGST ITC:</span><span className="font-mono">{fmt(setOff.itc_opening.cgst)}</span></div>
            <div className="flex justify-between"><span>SGST ITC:</span><span className="font-mono">{fmt(setOff.itc_opening.sgst)}</span></div>
          </div>
          <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20 space-y-2">
            ...
            <div className="flex justify-between"><span>IGST Cash:</span><span className="font-mono text-green-300">{fmt(setOff.cash_paid.igst)}</span></div>
            <div className="flex justify-between"><span>CGST Cash:</span><span className="font-mono text-green-300">{fmt(setOff.cash_paid.cgst)}</span></div>
            <div className="flex justify-between"><span>SGST Cash:</span><span className="font-mono text-green-300">{fmt(setOff.cash_paid.sgst)}</span></div>
            <div className="flex justify-between pt-1 border-t border-green-500/20 font-bold"><span>Total Cash:</span><span className="font-mono text-green-300">{fmt(setOff.cash_paid.total)}</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
        <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20">
          ...
          <p className="text-xl font-bold text-cyan-300 mt-1">{recon.reconciliation_score_pct}%</p>
        ...
        <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20">
          ...
          <p className="text-xl font-bold font-mono text-green-300 mt-1">{fmt(recon.eligible_itc_claimable)}</p>
        ...
        <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/20">
          ...
          <p className="text-xl font-bold font-mono text-red-400 mt-1">{fmt(recon.ineligible_missing_2b)}</p>
        ...
        <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
          ...
          <p className="text-xl font-bold font-mono text-amber-300 mt-1">{fmt(recon.blocked_itc_sec_17_5)}</p>
  ...
  return (
    <div className="space-y-4">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeTab === "forms" && <IncomeTaxFormsTab form138={form138} form140={form140} form143={form143} form144={form144} pan={pan} tan={tan} />}
          {activeTab === "advance" && <AdvanceTaxTab at={advanceTax} />}
          {activeTab === "tds" && <TDSVaultTab />}
          {activeTab === "gst" && <GSTFilerTab setOff={gstr3bSetOff} />}
          {activeTab === "gstr2b" && <GSTR2BReconTab recon={gstr2bRecon} />}
        </motion.div>
      </AnimatePresence>
    </div>
  );
