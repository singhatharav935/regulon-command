...
async function setupDatabase() {
  console.log('🔧 Setting up REGULON CA Dashboard Database...');
  ...
  try {
    ...
    if (!adminUser && !adminError) {
      ...
      const { error: insertError } = await supabase
        ...
        .insert([
          {
            firm_name: 'REGULON CA Services',
            email: 'admin@regulon.com',
            phone: '+91-9876543210',
            address: 'Mumbai, Maharashtra',
            registration_number: 'CA001REGULON',
            status: 'active'
          }
        ]);
    ...
    console.log(`
🎯 REGULON CA Dashboard Database Setup Complete!
