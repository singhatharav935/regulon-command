 ...
 * Complete overview of REGULON platform capabilities and performance
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold text-white mb-4">REGULON Platform Dashboard</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-lg text-slate-300 mb-8">
            Join leading CAs and organizations managing compliance intelligently with REGULON
          </p>
