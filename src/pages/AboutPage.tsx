...
/**
 * REGULON About Page - Professional Company Story and Team
...
const companyMilestones = [
  {
    ...
    description: "REGULON founded with vision to transform compliance through AI and automation",
    achievement: "Initial team of 8 compliance and technology experts"
  },
  {
    year: "2020",
    title: "Product Launch",
    description: "First REGULON platform launched for CA firms and small businesses",
...
const leadershipTeam = [
  {
    ...
    bio: "Former McKinsey consultant and compliance technology expert with 15+ years experience. Led digital transformation at major Indian banks before founding REGULON.",
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-4xl mb-12 leading-relaxed">
              Founded by compliance and technology experts, REGULON is pioneering the future of 
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="values" className="space-y-12">
            ...
            <Card className="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border-cyan-500/30">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-white mb-6">Why People Love Working at REGULON</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-300 text-sm">info@regulon.com</span>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Mail className="w-4 h-4 text-cyan-400" />
                        <span className="text-slate-300 text-sm">sales@regulon.com</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Phone className="w-4 h-4 text-cyan-400" />
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Mail className="w-4 h-4 text-cyan-400" />
                        <span className="text-slate-300 text-sm">press@regulon.com</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Globe className="w-4 h-4 text-cyan-400" />
                        <span className="text-slate-300 text-sm">regulon.com/press</span>
                      </div>
                    </div>
                  </div>
                </div>
