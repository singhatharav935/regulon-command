  ...
  const legalDocuments = [
    {
      ...
      description: "Comprehensive terms governing use of REGULON platform, user responsibilities, and service limitations.",
      path: "/terms",
      status: "ready",
        ...
        <div className="glass-card p-6 md:p-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Centralized access to all legal documents, policies, and compliance information for REGULON platform.
            </p>
          </div>
          ...
          <div className="border-t border-border/50 pt-8 mt-8">
            ...
            <div className="bg-muted/30 rounded-lg p-4">
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>📧 <strong>Legal Inquiries:</strong> legal@regulon.ai</li>
                <li>🔒 <strong>Privacy Questions:</strong> privacy@regulon.ai</li>
                <li>💳 <strong>Billing & Refunds:</strong> billing@regulon.ai</li>
                <li>💬 <strong>General Support:</strong> support@regulon.ai</li>
              </ul>
            </div>
          </div>
        </div>
