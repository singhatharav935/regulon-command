  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        {/* Key Benefits */}
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-white mb-8">Why CAs Choose SANNIDH</h2>
        ...
        >
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Join 1000+ CAs who are using SANNIDH to automate compliance and deliver better client service.
          </p>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="pt-6">
              <p className="text-slate-300 mb-6">
                SANNIDH seamlessly integrates with your existing tools and workflows:
              </p>
