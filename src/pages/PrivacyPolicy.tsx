          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                REGULON ("we," "our," or "us") respects your privacy and is committed to protecting your personal data. 
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-4">
                To exercise these rights, please contact us at <span className="font-mono text-sm">privacy@regulon.ai</span>
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                ...
                <p className="text-sm font-mono">Email: privacy@regulon.ai</p>
                <p className="text-sm font-mono">Email: dpo@regulon.ai</p>
