    ...
    items: [
      {
        ...
        description: "10-minute introduction to REGULON",
        duration: "10:30 min",
        level: "Beginner",
        views: 5200,
      },
...
const tools = [
  ...
  {
    name: "ROI Calculator",
    description: "Calculate your potential ROI with REGULON",
    type: "Calculator",
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mb-8">
            Comprehensive guides, tutorials, webinars, and tools to help you master REGULON and transform your
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Connect with other REGULON users",
                icon: "👥",
                link: "Visit Forum",
              },
              {
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-4">Master REGULON Today</h2>
