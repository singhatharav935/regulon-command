...
/**
 * SANNIDH Resource Center - Comprehensive Learning and Support Hub
  ...
  guides: [
    {
      ...
      title: "SANNIDH Quick Start Guide",
      description: "Get up and running with SANNIDH in 30 minutes. Complete setup, configuration, and first compliance workflow.",
      duration: "30 minutes",
      difficulty: "Beginner",
    ...
    },
    {
      ...
      description: "Complete developer guide for integrating SANNIDH APIs with your existing systems. Includes code samples and best practices.",
      duration: "2 hours",
      difficulty: "Advanced", 
  ...
  webinars: [
    {
      ...
      date: "April 15, 2026",
      duration: "60 minutes",
      speakers: ["Dr. Rajesh Mehta (Ex-RBI)", "Priya Sharma (Compliance AI Expert)", "Amit Gupta (SANNIDH CTO)"],
      attendees: "2,500+",
      recording: true,
      upcoming: true
    },
...
const trainingPrograms = [
  {
    ...
    duration: "40 hours",
    modules: 8,
    certification: "SANNIDH Certified",
    price: "₹25,000",
  ...
  {
    id: "enterprise-admin",
    title: "SANNIDH Enterprise Administrator",
    description: "Technical certification for system administrators and IT professionals managing enterprise SANNIDH deployments.",
    duration: "16 hours",
    modules: 4,
...
const supportResources = [
  ...
  },
  {
    ...
    posts: "15,000+",
    categories: 25,
    moderators: "Expert volunteers and SANNIDH team"
  },
  {
    type: "Knowledge Base",
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white flex items-center gap-3">
                  ...
                  SANNIDH API Documentation
                </CardTitle>
                <CardDescription className="text-slate-400">
                  Comprehensive developer resources for integrating SANNIDH with your systems
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 rounded-lg p-8 border border-slate-600">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      <p className="text-slate-300 mb-4">Get started with SANNIDH API in minutes:</p>
