...
/**
 * SANNIDH Enterprise Platform - Complete Technical Overview
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="integrations" className="space-y-12">
            ...
            >
              ...
              <p className="text-lg text-slate-300 mb-12 max-w-4xl">
                Connect SANNIDH with your existing tech stack. Our platform offers native integrations 
        ...
        >
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Join 1,200+ organizations already using SANNIDH to stay ahead of regulatory changes. 
