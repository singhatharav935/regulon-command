          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using SANNIDH ("the Platform"), you accept and agree to be bound by these Terms of Service. 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                SANNIDH is a regulatory compliance intelligence platform that provides:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                and software, are the property of SANNIDH and are protected by copyright, trademark, and other intellectual 
                property laws.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
                ...
                <p className="text-muted-foreground">
                  THE PLATFORM IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND. SANNIDH DOES NOT 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                TO THE FULLEST EXTENT PERMITTED BY LAW, SANNIDH SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, 
            ...
            <section>
              ...
              <div className="bg-muted/50 rounded-lg p-4 mt-4">
                <p className="text-sm font-mono">Email: legal@sannidh.ai</p>
