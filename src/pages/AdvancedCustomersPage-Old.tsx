...
const testimonials = [
  {
    ...
    image: "RK",
    quote:
      "REGULON reduced our compliance overhead by 70%. We went from manual tracking to fully automated intelligent monitoring. It's transformed how we manage regulatory risk.",
    rating: 5,
  ...
  },
  {
    ...
    image: "PS",
    quote:
      "As a CA firm managing 2000+ clients, REGULON is a game-changer. We can now handle 3x more clients without additional compliance staff. Client satisfaction is at an all-time high.",
    rating: 5,
...
const caseStudies = [
  {
    ...
    solution: "Implemented REGULON for centralized monitoring, automated task generation, team collaboration",
    results: {
  ...
  },
  {
    ...
    solution: "Deployed REGULON for automated compliance tracking, smart task assignment, client dashboards",
    results: {
  ...
  },
  {
    ...
    solution: "Integrated REGULON for real-time monitoring, impact analysis, integrated legal workflows",
    results: {
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mb-8">
            1000+ organizations across India rely on REGULON for intelligent regulatory compliance. See how our
