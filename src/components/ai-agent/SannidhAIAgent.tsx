  ...
  useEffect(() => {
    ...
    if (SpeechRecognition) {
      ...
      recognitionRef.current.onresult = (event: any) => {
        ...
        // Check for "Hey Sannidh" wake-word
        if (isFinal && (lowerTranscript.includes("hey sannidh") || lowerTranscript.startsWith("hey sannidh"))) {
          setIsListening(true);
          ...
          // Text-to-Speech: Sannidh responds
          const utterance = new SpeechSynthesisUtterance(
            "Hey, this is Sannidh AI, your compliance partner. Tell me what you need."
          );
          utterance.rate = 1;
          utterance.pitch = 1;
          utterance.volume = 1;
...
What would you like me to do next?`;
  ...
  return (
    <>
      {/* Siri-like "Hey Sannidh" Interface with Animated Circles */}
      <AnimatePresence>
        {showSiriInterface && (
          <motion.div
          ...
          >
            <motion.div className="text-center">
              ...
              >
                <h2 className="text-4xl font-bold text-cyan-400 mb-2">SANNIDH AI</h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-cyan-400">
                  {isListening ? "Listening..." : "Sannidh AI"}
                </p>
                <p className="text-xs text-muted-foreground">
                  {isListening ? '🎤 Say "Hey Sannidh"' : "Click to activate"}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="glass-card border-cyan-500/30 bg-card/95 backdrop-blur-xl shadow-2xl">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="flex gap-3">
              <Textarea
                placeholder='Say "Hey Sannidh" or type here...\n• "Draft GSTR-3B response"\n• "Check GST notices"\n• "Reconcile data"'
                value={userInput}
            ...
            {tasks.length > 0 && (
              <div className="pt-2 border-t border-border/50">
                <p className="text-xs text-muted-foreground mb-2">
                  {tasks.length} pending tasks • Say "Hey Sannidh, show tasks"
                </p>
