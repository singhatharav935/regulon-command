...
export const UserOnboardingFlow: React.FC = () => {
  ...
  const getRoleContent = (role: string): RoleSpecificContent => {
    switch (role) {
      case 'company_owner':
        return {
          welcomeTitle: 'Welcome to SANNIDH for Business Owners',
          ...
          learningResources: [
            {
              title: 'Getting Started with SANNIDH',
      ...
      case 'in_house_ca':
        return {
          welcomeTitle: 'Welcome to SANNIDH for Chartered Accountants',
          ...
          learningResources: [
            {
              ...
              description: 'Optimize your practice with SANNIDH',
              type: 'video',
              duration: '8 min'
            },
            {
      ...
      case 'ca_firm':
        return {
          welcomeTitle: 'Welcome to SANNIDH for CA Firms',
      ...
      case 'in_house_lawyer':
        return {
          welcomeTitle: 'Welcome to SANNIDH for Legal Professionals',
      ...
      default:
        return {
          welcomeTitle: 'Welcome to SANNIDH',
  ...
  const getDashboardRoute = (role: string): string => {
    switch (role) {
      ...
      default:
        return '/dashboard';  // TEMP: default to demo dashboard
    }
  };
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Add your professional details to personalize your SANNIDH experience
              </p>
            </div>
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Explore these resources to master SANNIDH and excel in your role
              </p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xl text-gray-600">
                Welcome to SANNIDH! Your account is ready and you can now access all features.
              </p>
            </div>
