# How REGULON Connects to Government Portals
...
User uploads → REGULON parses → Data stored in DB
```
...
3. Email received: "Your GST-3B for April has been ACCEPTED"
   ↓
4. REGULON's email parser captures it
   Status: ACCEPTED
   Amount: ₹7.5 lakhs
   Filing ID: GST-2024-04-001
```
...
**Hour 2: Data Sync**
```
5. REGULON scraper runs (every 30 min)
...
📄 **This file**: `/Users/atharavsingh/Desktop/REGULON_MASTER/frontend/GOVERNMENT_INTEGRATION.md`
...
**Use this for**:
- Understanding how REGULON gets data
