# REGULON - Advanced Regulatory Compliance Intelligence Platform
...
```bash
git clone https://github.com/yourusername/regulon-command.git
cd regulon-command
```
...
```bash
docker build -t regulon:latest .
docker run -p 3000:3000 -p 5173:5173 -p 8787:8787 regulon:latest
```
...
- **Email**: support@regulon.in
- **Website**: https://regulon.in

---

## 📄 License

REGULON is proprietary software. All rights reserved.
...
**REGULON - Making Regulatory Compliance Intelligent** 🚀
