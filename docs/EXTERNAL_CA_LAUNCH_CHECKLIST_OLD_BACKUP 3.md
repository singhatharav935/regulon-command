...
- **Sending**: Emails from noreply@sannidh.in (branded), include CA name, action link (direct to dashboard)
...
**Impact**: CA must manually copy data from accounting software to SANNIDH  
**Fix Time**: 2 weeks  
...
- **Knowledge base**: Searchable help center (help.sannidh.in)
...
- **Support channels**:
  1. **Email**: support@sannidh.in (respond within 24 hours)
...
- **Compliance items**:
  ...
  5. **Data Processing Agreement (DPA)**: Legal doc that CA signs (e.g., "SANNIDH will encrypt your data, store securely, not sell to third parties")
