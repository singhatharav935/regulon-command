...
The SANNIDH frontend application has been audited for security vulnerabilities following OWASP guidelines. The application demonstrates good security practices overall.
...
The SANNIDH application demonstrates solid security practices for a compliance platform. The identified vulnerabilities are primarily in development dependencies and do not pose significant production risks. 
